...
const Why = () => {
    return (
        <div id="whyus" style={{background:"#eff6ff"}}>

            <div className='mx-auto max-w-7xl px-4 my-20 pb-10 sm:py-0 lg:px-8 lg:my-36 lg:py-16'>
                        ...
                        <div className="mt-10">
                            {whydata.map((items, i) => (
                                <div className="flex mt-4" key={i}>
                                    <div className="rounded-full h-10 w-12 flex items-center justify-center bg-blue aspect-square">
